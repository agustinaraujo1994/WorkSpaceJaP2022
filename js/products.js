    ...
    for(let i = 0; i < array.length; i++){ 
        ...
        if (((minCount == undefined) || (minCount != undefined && parseInt(productArray.products[i].cost) >= minCount)) &&
            ...
            <div class="list-group-item list-group-item-action">
                <div class="row">
                    <div class="col-3">
                        <img src="` + productArray.products[i].image + `" alt="product image" class="img-thumbnail">
                    </div>
                    <div class="col">
                        <div class="d-flex w-100 justify-content-between">
                            <div class="mb-1">
                            <h4>`+ productArray.products[i].name  +` - ` + productArray.products[i].currency +` `+  productArray.products[i].cost+ `</h4> 
                            <p> `+ category.description +`</p> 
                            </div>
                            <small class="text-muted">` + productArray.products[i].soldCount + ` vendidos</small> 
                        </div>
